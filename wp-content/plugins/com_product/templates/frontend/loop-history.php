 ...
 <table id="com_product16" class="com_product16" cellpadding="0" cellspacing="0" width="100%">
	...
	<tbody>
		...
		for ($i=0; $i < count($data); $i++) { 
			...
			$total_price=str_replace(".", "", $data[$i]["total_price"]) ;
			$code=$data[$i]["code"];
			...
			<tr>
				...
				<td align="right"><?php echo $data[$i]["total_price"]; ?></td>
				<td align="center"><?php echo $status; ?></td>
				<td align="center"><a  data-toggle="modal" data-target="#modal-history-invoice" onclick="showLstInvoiceDetail('<?php echo $lnk_image ;  ?>',<?php echo $id; ?>,<?php echo $quantity ?>,<?php echo $total_price; ?>);">Xem</a></td>
			</tr>
			<?php
		}
		?>			 					
